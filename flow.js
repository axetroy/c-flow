...
var Flow = function () {
  ...
  _createClass(Flow, [{
    ...
    value: function _next(lastTask) {
      ...
      var currentTask = this.__tasksInQueue.shift();
    ...
    value: function run() {
      ...
      for (var i = 0; i < this.__concurrent; i++) {
        tasks.push(this.__tasksInQueue.shift());
      }

      // start run task
      tasks.forEach(function (task) {
        return task.call(_this, _this._next.bind(_this, task));
      });

      return new Promise(function (resolve, reject) {
        return _this.done = resolve;
      });
    }
  }]);
